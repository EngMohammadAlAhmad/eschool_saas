    ...
    return Padding(
      ...
      child: Column(
        children: (childFeeDetails.installments ?? []).map((installment) {
          ...
          // For paid installments, show the full paid amount.
          // For unpaid installments, show the remaining amount after deducting paid and advance amounts.
          double installmentAmount = isThisPaidInstallment
              ? (installment.installmentAmount ?? 0.0) - totalAdvancePaidAmount
              : installment.remainingAmount - totalAdvancePaidAmount;
          ;
